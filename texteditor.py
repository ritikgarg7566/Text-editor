...
text_editor.config(yscrollcommand=scroll_bar.set)
  ...
  #font size and font family fuctionality
...
view.add_checkbutton(label='Tool Bar',onvalue=True,offvalue=False,variable=show_toolbar,compound=tk.LEFT,command=hide_toolbar)
view.add_checkbutton(label='Status Bar',onvalue=True,offvalue=False,variable=show_statusbar,compound=tk.LEFT,command=hide_statusbar)
   #color_theme
def change_theme():
